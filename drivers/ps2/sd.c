...
static long ps2sd_ioctl(struct file *, unsigned int, unsigned long);
...
static long
ps2sd_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
