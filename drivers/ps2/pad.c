...
static long ps2pad_ioctl(struct file *, unsigned int, unsigned long);
...
static long ps2pad_ctl_ioctl(struct file *, unsigned int, unsigned long);
...
static long
ps2pad_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	int i, res;
	struct ps2pad_dev *dev = filp->private_data;
...
static long
ps2pad_ctl_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	/*
	int res;
	struct ps2pad_ctl_dev *dev = filp->private_data;
